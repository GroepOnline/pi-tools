...
Python bindings for [FFF (Fast File Finder)](https://github.com/GroepOnline/pi-tools), built with [PyO3](https://pyo3.rs/) and [Maturin](https://www.maturin.rs/). Install with `pip install fff-search`; import as `fff`.
